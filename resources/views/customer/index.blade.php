              ...
              <div class="col-lg-6">
                ...
                <form action="#">
                  <div class="form-group d-flex">
                    <input type="text" class="form-control" placeholder="ID RESI" name="resi_id" id="wew">
          ...
          <div class="owl-carousel nonloop-block-13">
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="depot/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="depot/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="depot/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-5 d-block blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="single.html" class="blog-thumbnail mb-3 d-block"><img src="depot/images/depot_img_1.jpg" alt="Image" class="img-fluid"></a>
            ...
            <div class="col-lg-6">
              <div class="mb-5 d-block blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="single.html" class="blog-thumbnail mb-3 d-block"><img src="depot/images/depot_img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="blog-excerpt">
                  <span class="d-block text-muted">Apr 19, 2019</span>
                  <h2 class="h4  mb-3"><a href="single.html">Knowing the Difference Is Key to Effective Logistics</a></h2>
