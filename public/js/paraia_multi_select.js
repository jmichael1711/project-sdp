    ...
    var methods = {
        init: function (options) {
            ...
            select = $(
                ...
                '       <div class="filter">' +
                '           <input style="text-transform:uppercase;" type="text" class="form-control" placeholder="' + settings.filter_text + '">' +
            ...
            settings.items.forEach(function (item) {
                ...
                select.find('.items').append(
                    ...
                    '       <input type="checkbox" name="arr[]" value="'+ item['value'] +'" class="custom-control-input" id="' + selectId + '-chbx-' + item['value'] + '" ' + (settings.defaults.includes(item['value']) ? 'checked' : '') + '>' +
